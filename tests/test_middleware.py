...
def test_valid_config_definition():
    ...
    expected_response = {
        ...
        'access_token_expires': 'P2D',
        'access_token_path': '/',
        'access_token_domain': None,
        'access_token_secure': False,
        'access_token_httponly': False,
        'access_token_samesite': 'lax',
        'refresh_token_name': 'refresh',
        'refresh_token_expires': 'P14D',
        'refresh_token_path': '/',
        'refresh_token_domain': None,
        'refresh_token_secure': False,
        'refresh_token_httponly': False,
        'refresh_token_samesite': 'lax',
        'encode_algorithm': 'HS256',
        'encode_headers': None,
        'encode_json_encoder': None,
        'encode_sort_headers': True,
        'decode_algorithms': ['HS256'],
        'decode_options': None,
        'decode_verify': None,
        'decode_detached_payload': None,
